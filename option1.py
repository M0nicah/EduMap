...
# PAGE 2: SCHOOL DETAILS
    ...
    with tab3:
        class_shortage = filtered_df.nlargest(10, 'extra_classes_required')[['Name_of_Sc', 'District', 'extra_classes_required']]
...
# PAGE 3: GEOGRAPHIC ANALYSIS
    ...
    # Priority map
    st.subheader("Province Priority Levels")
    filtered_df['Priority'] = filtered_df['Extra_Teachers_Required'] + filtered_df['extra_toilets_required']
...
# PAGE 4: RESOURCE ANALYSIS
    ...
    with col1:
        ...
        fig, ax = plt.subplots()
        ax.hist(filtered_df['Total_Students'], bins=15, color='#4ecdc4')
    ...
    # Sponsor analysis
    st.subheader("Schools by Sponsor")
    sponsor_count = filtered_df['SchSponsor'].value_counts().head(5)
    st.bar_chart(sponsor_count, color='#45b7d1')

# PAGE 5: COMPARISONS
elif page == "⚖️ Comparisons":
    st.title("⚖️ District Comparisons")
    ...
    if d1 and d2 and d1 != d2:
        ...
        st.info("Please select two different districts to compare")